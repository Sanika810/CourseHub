  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-2xl p-8 w-full max-w-md shadow-2xl">
        ...
        {error && (
          <div className="bg-red-900 bg-opacity-50 border border-red-700 text-red-200 px-4 py-3 rounded-lg mb-6">
            {error}
          </div>
        )}
        ...
        {isLogin && (
          <div className="mt-6 p-4 bg-gray-700 rounded-lg">
            <p className="text-xs text-gray-300 mb-2">Demo Admin Account:</p>
            <p className="text-xs text-gray-400">First registered user becomes admin</p>
            <p className="text-xs text-gray-400">Or use: admin@coursehub.com / password</p>
          </div>
        )}
      </div>
    </div>
